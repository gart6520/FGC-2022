    ...
    */
        ...
        // The main mode to run the robot
            ...
            if(gamepad2.triangle) {
                stV = shooter.calculate(ProjectileCalculator.getAngleRate(), shooter.getVelocity());
            }
            ...
            // During the auto mode of hood, the pid controller will calculate the necessary value
            if(hdAutoMode) {
